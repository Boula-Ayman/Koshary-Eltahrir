          ...
          <div className="space-y-6">
            ...
            <form className="space-y-4 bg-gray-50 p-6 rounded-xl shadow-md">
              <input
                type="text"
                placeholder="اسمك"
                className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#8dc88c]"
              />
              <input
                type="email"
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#8dc88c]"
              ></textarea>
              <button className="bg-[#8dc88c] border border-#8dc88c text-white px-6 py-2 rounded-lg  transition">
                إرسال
              </button>
            </form>
          </div>
